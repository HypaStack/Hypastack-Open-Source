  ...
  return (
    <main className="flex min-h-screen flex-col bg-white">
      ...
      <section className="relative flex flex-1 flex-col items-center justify-center px-4 sm:px-6 pt-32 pb-24 min-h-[70vh]">
        ...
        >
          <div style={{ borderRadius: 6, backgroundColor: '#ffffff', border: '1px solid #e5e5e5', boxShadow: '0 2px 12px rgba(0,0,0,0.06)' }}>
            <div style={{ borderRadius: 6, padding: 24 }}>
              ...
              {error?.digest && (
                <p className="text-[11px] text-[#bbb] font-mono mb-5 bg-[#f5f5f5] border border-[#ebebeb] rounded-md px-3 py-2">
                  ref: {error.digest}
                </p>
              )}
              <div className="flex gap-2">
                <button
                  ...
                  style={{ height: 38, paddingLeft: 16, paddingRight: 16, borderRadius: 6, fontSize: 13, fontWeight: 600, color: '#111', backgroundColor: '#f5f5f5', border: '1px solid #e5e5e5' }}
                >
                  Try Again
                </button>
                <Link
                  ...
                  style={{ height: 38, paddingLeft: 16, paddingRight: 16, borderRadius: 6, fontSize: 13, fontWeight: 500, color: '#fff', backgroundColor: '#111' }}
                >
                  Home
                </Link>
              </div>
