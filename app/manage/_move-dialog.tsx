    ...
    <>
      ...
      <div className="fixed inset-0 z-[70] flex items-center justify-center p-4 pointer-events-none">
        <motion.div
          ...
          className="relative w-full max-w-md flex flex-col rounded-[16px] bg-white dark:bg-[#0a0b0c] border border-[#e5e5e5] dark:border-[rgba(255,255,255,0.08)] overflow-hidden pointer-events-auto"
        >
