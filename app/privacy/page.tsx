      ...
      <section className="flex-1 pt-32 pb-40">
        <div className="mx-auto max-w-[860px] px-4 sm:px-6 lg:px-8">
          ...
          <div className="space-y-12 text-[15px] leading-relaxed text-muted-foreground">
            <section>
              <h2 className="text-2xl font-semibold text-foreground mb-5">1. Introduction to Zero-Knowledge</h2>
            ...
            <section>
              <h2 className="text-2xl font-semibold text-foreground mb-5">3. Information We Do NOT Collect</h2>
              <p className="mb-4">
            ...
            <section>
              <h2 className="text-2xl font-semibold text-foreground mb-5">4. Third-Party Sharing</h2>
              <p className="mb-4">
            ...
            <section>
              <h2 className="text-2xl font-semibold text-foreground mb-5">5. Data Retention and Deletion</h2>
              <p className="mb-4">
