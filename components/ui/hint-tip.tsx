    ...
    <AnimatePresence>
      {isVisible && (
        <motion.div
          ...
          className="fixed bottom-28 left-1/2 -translate-x-1/2 flex items-center justify-center gap-2 text-[14px] font-medium text-[#333] dark:text-[#ccc] bg-white dark:bg-[#1c1c1c] border border-[#e5e5e5] dark:border-transparent pl-5 pr-3 py-2.5 rounded-[20px] w-[max-content] max-w-[90vw] z-40"
