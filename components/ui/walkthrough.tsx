  ...
  return (
    <AnimatePresence mode="wait">
      <motion.div
        ...
        className="fixed bottom-24 sm:bottom-28 left-1/2 -translate-x-1/2 flex items-center gap-2 sm:gap-2.5 text-[13px] sm:text-[14px] font-medium text-[#333] dark:text-[#e3e3e3] bg-white dark:bg-[#1e1e20] border border-[#e5e5e5] dark:border-[rgba(255,255,255,0.08)] pl-4 sm:pl-5 pr-2.5 sm:pr-3 py-2.5 rounded-md w-max max-w-[calc(100vw-1.5rem)] sm:max-w-md z-40 text-center sm:text-left"
