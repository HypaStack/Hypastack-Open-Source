            ...
            >
              <div>
                ...
                <a
                  ...
                  className="relative inline-flex items-center justify-center p-[1px] rounded-full overflow-hidden shrink-0 group active:scale-[0.98] transition-transform duration-150"
                >
                  ...
                  <div className="relative bg-[#151616] rounded-full px-6 py-3 flex items-center gap-3 w-full h-full">
                    ...
                    <span className="text-[16px] font-medium text-[#f7f8f8]">Source code</span>
                  </div>
                </a>
                </div>
