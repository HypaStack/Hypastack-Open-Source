            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mt-16 sm:mt-24">
              <div className="relative overflow-hidden rounded-md p-[1px]">
                ...
                <div className="relative z-10 bg-[#0a0b0c] h-full w-full rounded-[5px] p-8 flex flex-col items-start">
                  <img src="https://r2.hypastack.com/cdn/s422hnlic6gc/feature-1.svg" alt="Built for purpose" className="w-16 h-16 sm:w-20 sm:h-20 mb-8 select-none pointer-events-none" draggable={false} />
              ...
              <div className="relative overflow-hidden rounded-md p-[1px]">
                ...
                <div className="relative z-10 bg-[#0a0b0c] h-full w-full rounded-[5px] p-8 flex flex-col items-start">
                  <img src="https://r2.hypastack.com/cdn/5mjl7qamo25p/feature-2.svg" alt="Powered by Cloudflare" className="w-16 h-16 sm:w-20 sm:h-20 mb-8 select-none pointer-events-none" draggable={false} />
              ...
              <div className="relative overflow-hidden rounded-md p-[1px]">
                ...
                <div className="relative z-10 bg-[#0a0b0c] h-full w-full rounded-[5px] p-8 flex flex-col items-start">
                  <img src="https://r2.hypastack.com/cdn/rid8jnqs5p6n/feature-3.svg" alt="Designed for speed" className="w-16 h-16 sm:w-20 sm:h-20 mb-8 select-none pointer-events-none" draggable={false} />
