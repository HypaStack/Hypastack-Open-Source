  ...
  return (
    <div className="fixed inset-0 z-[100] flex items-center justify-center p-4">
      ...
      <motion.div 
        ...
        className="relative w-full max-w-[420px] flex flex-col bg-[#f0f0f0] dark:bg-[#0f0f11] border border-[rgba(0,0,0,0.08)] dark:border-[rgba(255,255,255,0.08)] sm:rounded-[20px]"
        style={{
