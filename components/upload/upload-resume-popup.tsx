      ...
      {show && session && (
        <>
          ...
          <motion.div
            ...
            className="fixed z-[201] left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2 w-[90vw] max-w-[420px] rounded-[20px] overflow-hidden"
            ...
            <div className="p-6">
              ...
              <div className="flex gap-3">
                <button
                  type="button"
                  onClick={onAbort}
                  className="flex-1 px-4 py-2.5 rounded-[16px] bg-[#171717] hover:bg-[#313131] text-[14px] font-semibold text-foreground transition-colors"
                >
                  Abort
                </button>
                <button
